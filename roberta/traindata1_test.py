...
if __name__ == "__main__":
    ...
    #保留散度大的样本在微调前后的颗粒状况
    # python ../../traindata1_test.py --state ft --dataset mrpc --seed 42 --reg 5e-8 --weight_decay 0.0 --epoch 10 --remain_loss 1 --model bert-base-uncased --target_ratio 0.5 --pruneFlag up --optim adamw_torch
