...
def main():
    ...
    scores1={key: abs(loss_gap_after[key]-loss_gap_before[key])/loss_gap_before[key] for key in loss_gap_after if key in loss_gap_before}
    scores2={key: loss_gap_after[key] for key in loss_gap_after if key in loss_gap_before}
