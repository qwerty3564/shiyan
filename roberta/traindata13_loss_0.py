...
if __name__ == "__main__":
    ...
    #剪枝标准：
            #模型对样本的损失的绝对值
    #从头开始训练
    # python ../../traindata13_loss_0.py --state ft --dataset mrpc --seed 3404 --reg 5e-8 --weight_decay 0.002 --epoch0 1 --epoch 10 --remain_loss 1 --model bert-base-uncased --target_ratio 0.5 --batchsize 32 --pruneFlag up --optim adamw_torch
