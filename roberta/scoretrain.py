...
if __name__ == "__main__":
    main()
    # 剪枝标准：
        # 初始模型微调前后对样本的768维颗粒的1Norm之差
    # 测试集样本在微调前后的颗粒状况
    #先统计每个样本微调前后的散度（得分），再以两者之差作为数据选择的依据
    # python ../scoretrain.py --state ft --dataset mrpc --seed 3404 --reg 5e-8 --weight_decay 0.0 --epoch0 1 --epoch 10 --remain_loss 1 --model bert-base-uncased --target_ratio 0.5 --pruneFlag up --optim adamw_torch